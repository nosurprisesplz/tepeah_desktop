import {createFlightSchedule, updateFlightSchedule} from "@renderer/Controller/GeneralControls/FlightController"
import {getAllPlane} from "@renderer/Controller/GeneralControls/PlaneController"
import locationsArray, {Flight} from "@renderer/Controller/Interfaces/FlightInterface"
...
function UpdateFlightDetail(p : Props) {
    ...
    const submitHandle = () => {
        updateFlightSchedule(p.flight ,source, destination, date, duration, planeID).then((result) => {
    ...
    return <div className={'px-20 py-5 flex items-center justify-center'}>
        <div className="bg-white p-8 rounded shadow-md w-1/2">
            <h2 className="text-2xl font-semibold mb-4">Update Flight Schedule</h2>
            <div className="mb-4">
...
export default UpdateFlightDetail;
