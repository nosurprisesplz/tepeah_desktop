import {createMaintenanceSchedule} from '@renderer/Controller/GeneralControls/MaintenanceController';
import {equipmentTypes, items} from '@renderer/Controller/Interfaces/MaintenanceInterface';
import React, {useState} from 'react';

function CreateMaintenanceSchedule(props) {
    ...
    const clickHandle = () => {
        createMaintenanceSchedule(type, days, desc, item, date).then((result) => {
            console.log(result);
